...
class VotingTestCase(BaseTestCase):
    ...
    # Practica 2: Prueba de Modelo - Ejercicio 1
    ...
    # Practica 2: Prueba de API- Ejercicio 1
    def test_create_voting_api(self):
        ...
        self.assertEquals(v.desc,'Description')
